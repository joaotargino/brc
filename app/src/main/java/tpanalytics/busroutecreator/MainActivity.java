...
//    private String local = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // location updates: at least 5 meters and 1secs change
        locationManager.requestLocationUpdates(provider, 5000, 1.0F, mylistener);
    ...
    public void onClick(View target) {
        if (localAtual != null) {
            ...
            if (target == dropbox) {
                ...
                iniciaViagem = true;
                horaInicioViagem = hr + "_" + min + "_" + sec;
...
//            System.out.println(getApplicationContext().getFilesDir().getPath());
                ...
                //escrever arquivo
                String filenameParadas = nomeRota.getText().toString() + "_" + horaInicioViagem + "_paradas.txt";
                File fileParadas = new File(getApplicationContext().getFilesDir().getPath(), filenameParadas);
                FileOutputStream outputStreamParadas;

                String filenameInexistentes = nomeRota.getText().toString() + "_" + horaInicioViagem + "_inexistentes.txt";
                ...
                String filenameRota = nomeRota.getText().toString() + "_" + horaInicioViagem + "_rota.txt";
            ...
            Toast.makeText(this, "Atenção! Localização indisponível! Verifique o sinal GPS e tente novamente",
                    Toast.LENGTH_SHORT).show();
        }
